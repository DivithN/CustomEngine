...
namespace eae6320
{
	...
	private:
		...
		const char* GetMainWindowClassName() const final { return "Divith's Game Main Window Class"; }
		...
		const WORD* GetLargeIconId() const final { static constexpr WORD iconId_large = IDI_CASTLEOFCARDBOARD; return &iconId_large; }
		const WORD* GetSmallIconId() const final { static constexpr WORD iconId_small = IDI_CASTLEOFCARDBOARD; return &iconId_small; }
