...
void eae6320::Graphics::sContext::ClearColor(float i_backgroundColor[4])
{
	...
	// by "clearing" the image buffer (filling it with a solid color)
	{
		...
		{
			glClearColor(i_backgroundColor[0], i_backgroundColor[1], i_backgroundColor[2], i_backgroundColor[3]);
...
eae6320::cResult eae6320::Graphics::sContext::InitializeViews(
	const sInitializationParameters& i_initializationParameters)
{
