...
namespace eae6320
{
	namespace Graphics
	{
		...
		cResult SubmitMeshEffect(cMesh* i_Mesh, cEffect* i_Effect, eae6320::Math::cMatrix_transformation i_transform);
		cResult SubmitCamera(eae6320::Math::cMatrix_transformation i_CamTransform, eae6320::Math::cMatrix_transformation i_CamSettings);
	}
}
